package kr.co.inseok.springbootvuejs.controller;

import kr.co.inseok.springbootvuejs.domain.User;
import kr.co.inseok.springbootvuejs.exception.UserNotFoundException;
import kr.co.inseok.springbootvuejs.repository.UserRepository;
...
public class BackendController {
    ...
    public String addNewUser (@PathVariable("lastName") String lastName, @PathVariable("firstName") String firstName) {
